            ...
            ComposerHooksPanelState(
                ...
                hooks = listOf(
                    ComposerHookRowState(
                        ...
                        editForm = ComposerHookFormPreview(
                            scope = ComposerHookScopePreview.Project,
                            eventName = ComposerHookEventNamePreview.PreToolUse,
                            matcher = "Bash",
                            command = "scripts/check-command.sh",
                            timeoutSec = "30",
                            statusMessage = "Checking shell command",
                            editingScope = ComposerHookScopePreview.Project,
                            editingEventName = ComposerHookEventNamePreview.PreToolUse,
                        ),
                        trustLabel = "Modified",
                        sourceLabel = "Project",
                    ...
                    ComposerHookRowState(
                        ...
                        editForm = ComposerHookFormPreview(
                            ...
                            editingEventName = ComposerHookEventNamePreview.UserPromptSubmit,
                        ),
                        trustLabel = "Trusted",
                        sourceLabel = "User",
