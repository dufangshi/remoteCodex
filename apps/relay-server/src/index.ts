...
try {
  ...
  if (error instanceof ZodError) {
    ...
    console.error('');
    console.error('Required: REMOTE_CODEX_RELAY_SUPERVISOR_TOKEN, REMOTE_CODEX_ADMIN_USERNAME, REMOTE_CODEX_ADMIN_PASSWORD');
    console.error('Optional: REMOTE_CODEX_ADMIN_EMAIL, REMOTE_CODEX_RELAY_CLIENT_TOKEN, REMOTE_CODEX_RELAY_SESSION_SECRET, REMOTE_CODEX_RELAY_DATA_DIR, REMOTE_CODEX_RELAY_WEB_DIST_DIR, HOST, PORT');
    process.exit(1);
  }
