...
6. [Control Plane To Sandbox Worker](./control-plane-sandbox-worker.md)
7. [Control Plane Auth](./control-plane-auth.md)
8. [Control Plane Session To Worker Contract](./control-plane-session-worker-contract.md)
9. [Local Control Plane, Router, And Worker Smoke](./local-control-plane-worker-smoke.md)
10. [Remote Codex Side Delivery Checklist](./remote-codex-side-delivery-checklist.md)
11. [Remote Codex Side Execution Checklist](./remote-codex-side-execution-checklist.md)
12. [Remote Codex Side Implementation Plan](./remote-codex-side-implementation-plan.md)
13. [Remote Codex Side Task Checklist](./remote-codex-side-task-checklist.md)
14. [Remote Codex Implementation Checklist](./remote-codex-implementation-checklist.md)
