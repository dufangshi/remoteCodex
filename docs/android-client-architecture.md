...
- Real workspace actions behind the current native action chips: refresh, upload, and file mutation. Workspace tree, file selection, load-more preview, raw open/copy, and file download now call the backend from the thread detail route.
