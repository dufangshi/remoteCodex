...
- Full markdown/GFM parity beyond the current native subset, especially math, advanced nested list continuation behavior, advanced syntax highlighting, and plugin-rendered inline artifacts.
