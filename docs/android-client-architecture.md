...
| `ThreadWorkspaceLayout.tsx` | `ThreadTopBar.kt` + `ThreadRoomsPanel.kt` | Mobile topbar with Web-like app menu/settings glyph buttons, action/thread glyph pills, segmented Chat/Workspace/Shell navigation, and rooms drawer with Web-like thread message and new-thread glyphs. |
