...
- Full markdown/GFM parity beyond the current native subset, especially math, nested lists, advanced syntax highlighting, and plugin-rendered inline artifacts.
