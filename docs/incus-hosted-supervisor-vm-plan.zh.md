...
- 对本分支 3 次成功 Relay Deploy run（`29132577362`、`29132252329`、`29132029058`）做真实模型 key 精确扫描，匹配数均为 0；tracked git、生产 relay logs 和 host-agent journal 的匹配数也均为 0。host-agent workflow 仍需合入默认分支后取得首次独立 deploy run 证据。
